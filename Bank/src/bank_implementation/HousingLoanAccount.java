...
public class HousingLoanAccount implements LoanAccount, DebitInterest {
	SavingsAccount sa;
	double principal;
	
	public HousingLoanAccount(SavingsAccount sa, double principal) {
		this.sa = sa;
	...
	public double calculateInterest() {
		...
		return principal * (CreditInterest.HousingLoanRate / 100);
	}
...
//		principal += calculateInterest();
	...
	public void payInterest() {
		System.out.println("Paying interest on housing loan account");
	}
