...
public class Circle implements Drawable, Fillable {
	...
	@Override
	public void draw() {
		System.out.println("Drawing " + drawingColor + " colored circle with brush thickness " + brushThickness);
	}
	
	@Override
	public void fill() {
		System.out.println("Filling circle of size " + fillSize + " units with " + fillingColor + " color");
	}
}
