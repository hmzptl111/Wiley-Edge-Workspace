...
public class GraphMain {
	...
	public static void main(String[] args) {
		...
		System.out.println(city + " is connected to the following cities:");
		for(String connectedCity: graph.getConnectedEdges(city)) {
			System.out.print(connectedCity + " ");
		}
		System.out.println();
		
		System.out.println("Total number of edges in graph is " + graph.getTotalNumberOfEdges());
	}
}